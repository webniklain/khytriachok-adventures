...
export class AudioManager {
  ...
  private backgroundMusicReady = false

  private backgroundMusicPlayRequested = false

  private readonly backgroundMusicUrl =
  ...
  public prepareBackgroundMusic(): void {
    ...
    music.addEventListener(
      ...
      () => {
        ...
        if (
          this.backgroundMusicPlayRequested &&
          music.paused
        ) {
          void this.startPreparedMusic()
        }
      },
    )
  ...
  public playBackgroundMusic(): void {
    this.backgroundMusicPlayRequested = true
    this.prepareBackgroundMusic()

    void this.startPreparedMusic()
  }

  private async startPreparedMusic(): Promise<void> {
  ...
  public stopBackgroundMusic(): void {
    this.backgroundMusicPlayRequested = false
    this.backgroundMusicReady = false
